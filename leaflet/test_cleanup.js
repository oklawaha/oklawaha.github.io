...
<head>
    ...
    <title>Leaflet Awesome Basemaps</title>
...
<body>
   ...
   <div id="bookmarks">
      <ul>
          <li><a href="#" onclick="findme()">LOCATE</a></li>
...
/*** MAP SERVICES ***/
	   ...
	   //https://services2.arcgis.com/FiaPA4ga0iQKduv3/arcgis/rest/services/EPA_Level_III_Ecoregions/FeatureServer/0
...
/*** ADD MARKERS ***/
        ...
        function point_pop(latlong,title,imgurl) {
            var popinfo;
            if (imgurl) {
                popinfo = '<strong><a href="' + imgurl + '"><img src="' + imgurl + '" width="200px" /></a><br>' + title + '</strong>';}
            else {popinfo = '<p>' + title + '</p>';}
                
            
            //var popinfo = '<p><a href="' + imgurl + '"><img src="' + imgurl + '" width="200px" /></a><br>' + title + '</p>';
        ...
        point_pop([30.2645,-97.7433],"J.W. Marriott Hotel");
